...
namespace PokemonPartySimulator.Presentation_Layer
{
    public partial class frmMoveSelect : Form
    {
        ...
        {
            // new 一個新的 BindingSource，否則會combox全部一起改變的問題
            BindingSource bs = new BindingSource();
            bs.DataSource = sourceTable; // 可以共用同一個 DataTable 
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            //使用 as 運算子比直接用 (int)強制轉型更安全，因為失敗時回傳 null，而不是報錯
            ...
            // C. 使用 LINQ 判斷：選中的招式數量 是否大於 去重複後的招式數量
